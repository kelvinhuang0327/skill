---
name: fable-method
description: Primary Fable Worker discipline for classifying asks, resolving Packet authority, executing bounded state-changing work, verifying by observation, and handing off honestly. Use for /fable-method, an authoritative Planner Packet, or any non-trivial state-changing task without a more specific execution skill.
---
